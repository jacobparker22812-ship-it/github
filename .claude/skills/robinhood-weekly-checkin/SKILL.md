...
4. `get_equity_quotes` for every held symbol. Use the most recent price
   and say what time it is from.
5. `get_equity_orders` since the last check-in (default: the last 7
   days): list fills, and flag anything still queued.
...
| Holding | Shares | Value | Cost | Gain/loss | Weight | Target |
|---|---|---|---|---|---|---|
| VTI | ... | ... | ... | ... | ...% | 70% |
| VXUS | ... | ... | ... | ... | ...% | 25% |
| Cash | | ... | | | ...% | 5% |
